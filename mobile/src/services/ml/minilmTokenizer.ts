import VOCAB_MINILM from 'src/assets/vocab_minilm.json';
...
class WordPieceTokenizer {
  ...
  constructor() {
    this.vocab = new Map(Object.entries(VOCAB_MINILM));
...
export const minilmTokenizer = new WordPieceTokenizer();