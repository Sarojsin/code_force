...
jest.mock('../../stores/companionStore', () => {
  ...
  return {
    ...
    XP_REWARDS: { journal_saved: 10, mood_logged: 5, water_logged: 3, exercise_completed: 8, period_logged: 15, period_corrected: 5, daily_login: 2 },
    COIN_REWARDS: { journal_saved: 2, mood_logged: 1, water_logged: 1, exercise_completed: 2, period_logged: 3, period_corrected: 1, daily_login: 1 },
