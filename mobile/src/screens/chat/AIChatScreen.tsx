/**
 * AIChatScreen — AI Health Assistant per UI_UX AI_Chat spec.
 * Minimal material design, suggestion chips, voice button, typing indicator.
 */
    ...
    return (
      <View style={[styles.messageRow, isAI ? styles.aiRow : styles.userRow]}>
        ...
        <View style={[
          ...
          <Text variant="body" style={{ color: isAI ? theme.colors.textPrimary : '#fff' }}>{item.text}</Text>
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: '#FFF8FB' }]} edges={['top']}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={Platform.OS === 'ios' ? 90 : 0}>
        ...
        <View style={[styles.header, { borderBottomColor: theme.colors.border }]}>
          ...
          <Pressable accessibilityLabel="Voice input" style={[styles.voiceBtn, { backgroundColor: theme.colors.accentMuted, borderRadius: theme.radius.pill }]}>
            <Svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <Path d="M12 1a3 3 0 00-3 3v8a3 3 0 006 0V4a3 3 0 00-3-3z" stroke={theme.colors.accent} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <Path d="M19 10v2a7 7 0 01-14 0v-2" stroke={theme.colors.accent} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <Line x1="12" y1="19" x2="12" y2="23" stroke={theme.colors.accent} strokeWidth="2" strokeLinecap="round" />
              <Line x1="8" y1="23" x2="16" y2="23" stroke={theme.colors.accent} strokeWidth="2" strokeLinecap="round" />
            </Svg>
          </Pressable>
        </View>
        ...
        <View style={[styles.inputBar, { backgroundColor: theme.colors.surface, borderTopColor: theme.colors.border }]}>
          ...
          <View style={styles.inputActions}>
            ...
            >
              <Svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <Path d="M12 1a3 3 0 00-3 3v8a3 3 0 006 0V4a3 3 0 00-3-3z" stroke={theme.colors.accent} strokeWidth="2" strokeLinecap="round" />
                <Path d="M19 10v2a7 7 0 01-14 0v-2" stroke={theme.colors.accent} strokeWidth="2" strokeLinecap="round" />
              </Svg>
            </Pressable>
            <Pressable
              onPress={() => handleSend()}
